...
<html lang="en">
  ...
  <body style="background-color :#00BFFF">
	    ...
	    <div class="container-fluid py-5">
		    <div class="row py-5">
			    <div class = "col-lg-12 col-mg-12 py-5 mr-auto">
			      <marquee behavior="scroll" direction="left" style="color:yellow"><b>Hello Customer, Welcome to The Spark Fund Bank<b></marquee>
				    <h4>Welcome to</h4>
				    <h3><b>The Spark Fund Bank</b></h3>
    ...
    <footer class="text-center mt-5 py-2" style="background-color:rgb(135,206,250);">
      <p>&copy 2023 Designed by <b>MD ARIF</b> <br> The Spark Fund Bank</p>
    </footer>
  </body>
</html>